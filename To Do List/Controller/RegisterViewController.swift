...
class RegisterViewController: UIViewController {
    ...
    @IBAction func register(_ sender: Any) {
        ...
        if let emailRecovered = self.email.text, let passwordRecovered = self.password.text, let passwordConfirmR = self.confirmPassword.text, let nameRecovered = self.name.text {
